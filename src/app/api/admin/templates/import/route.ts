...
const DEFAULT_TEMPLATES: DefaultTemplate[] = [
  ...
  { name: 'EGO', softwareType: 'ego', authType: 'CREDENTIALS', icon: '🎭', description: 'EGO platform - Login and scrape stats with datepicker' },
  { name: 'Mexos', softwareType: 'mexos', authType: 'CREDENTIALS', icon: '📊', description: 'Mexos Angular SPA - Login and scrape Traffic Stats' },
