...
const DEFAULT_TEMPLATES: DefaultTemplate[] = [
  ...
  { name: 'RTG Original', softwareType: 'rtg-original', authType: 'CREDENTIALS', description: 'Realtime Gaming original platform. Supports D-W-C revenue calculation.', icon: '🎮' },
